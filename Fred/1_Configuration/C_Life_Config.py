...
NeoPixelDiagConfig = [[1, 200,   0,   0, 200,   0,   0,   0], # pixel 1
    [1, 150,   0,   0, 200,   0,   0,   0],                   # Pixel 2
    [1, 100,   0,   0, 200,   0,   0,   0],                   # Pixel 3
    [1,  75,   0,   0, 200,   0,   0,   0],                   # Pixel 4
    [1,  50,   0,   0, 200,   0,   0,   0],                   # Pixel 5
    [1,  25,   0,   0, 200,   0,   0,   0],                   # Pixel 6
    [1,  10,   0,   0, 200,   0,   0,   0],                   # Pixel 7
    [3,   0,  10,   0,  10, 200, 200,   0],                   # Pixel 8
    [3,   0,  10,   0,  10, 200, 200,   0],                   # Pixel 9
    [2,  10,   0,   0, 200,   0,   0,   0],                   # Pixel 10
    [2,  25,   0,   0, 200,   0,   0,   0],                   # Pixel 11
    [2,  50,   0,   0, 200,   0,   0,   0],                   # Pixel 12
    [2,  75,   0,   0, 200,   0,   0,   0],                   # Pixel 13
    [2, 100,   0,   0, 200,   0,   0,   0],                   # Pixel 14
    [2, 150,   0,   0, 200,   0,   0,   0],                   # Pixel 15
    [2, 200,   0,   0, 200,   0,   0,   0],                   # Pixel 16
