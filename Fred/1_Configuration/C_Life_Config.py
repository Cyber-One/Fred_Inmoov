...
NeoPixelDiagConfig = [[1, 250,   0,   0, 200,  10,   0,   0], # pixel 1
    ...
    [4, 580,  50,   0,   0,  20,  50,   0],                   # Pixel 17
    [4, 600,  10,   0,   0,  20,  20,   0],                   # Pixel 18
    [4, 610,   0,  10,   0,  20,  20,   0],                   # Pixel 19
    [4, 620,   0,   0,  10,  20,  20,   0],                   # Pixel 20
    [4, 630,  10,   0,  10,  20,  20,   0],                   # Pixel 21
    [4, 640,   0,  10,  10,  20,  20,   0],                   # Pixel 22
    [4, 650,  10,  10,  10,  20,  20,   0]]                   # Pixel 23
